...
const HousesAll = async () => {
  ...
  const gryffindorRes = await apiHouses.get<Character[]>(
    "/characters/house/gryffindor",
  );
  const slytherinRes = await apiHouses.get<Character[]>(
    "/characters/house/slytherin",
  );
  const ravenclawRes = await apiHouses.get<Character[]>(
    "/characters/house/ravenclaw",
  );
  const hufflepuffRes = await apiHouses.get<Character[]>(
